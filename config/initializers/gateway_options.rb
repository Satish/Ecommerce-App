...
GATEWAY_OPTIONS = {
                   ...
                   "Paypal - Website Payments Pro" => [
                                       { :name => "login",      :description => "Your login email." },
                                       { :name => "password",   :description => "Your Paypal API Credentials Password." },
                                       { :name => "signature",  :description => "Your Paypal API Credentials signature string." }
                                      ]
                 }